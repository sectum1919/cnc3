...
model = "/work9/cchen/project/CNCeleb/cnc3/getpoi/facenet_code/20180402-114759"
...
def download(keyword, page, savedir):
    needurl = 'http://image.baidu.com/search/flip?tn=baiduimage&ie=utf-8&word=' + keyword + "&pn=" + str(page * 60)
